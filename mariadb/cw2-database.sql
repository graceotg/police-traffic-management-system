...
--
-- Host: mariadb
-- Generation Time: Dec 18, 2024 at 10:58 PM
...
INSERT INTO `AuditLogs` (`audit_id`, `user_id`, `table_name`, `record_id`, `action`, `details`, `created_at`) VALUES
(1, 3, 'Vehicle', '642', 'INSERT', '\"Vehicle ID: 642, was added\"', '2024-12-17 18:56:38'),
(2, 3, 'Incident', '10', 'INSERT', '\"Ownership successfully linked (People_ID: 83, Vehicle_ID: 67)\"', '2024-12-17 19:06:31'),
(3, 3, 'Incident', '13', 'INSERT', '\"Ownership successfully linked (People_ID: 452, Vehicle_ID: 166)\"', '2024-12-17 19:08:01'),
(4, 3, 'Incident', '514', 'INSERT', '\"Person ID: 514, was created\"', '2024-12-17 21:04:04'),
(5, 3, 'People', '515', 'INSERT', '\"Person ID: 515, was created\"', '2024-12-17 21:05:06'),
(6, 3, 'Officers', '21', 'INSERT', '\"Officer with ID: 21, was created\"', '2024-12-17 21:08:12'),
(7, 3, 'Incident', '6', 'INSERT', '\"Incident ID: 6, was created\"', '2024-12-17 21:18:15'),
(8, 3, 'Fines', '5', 'INSERT', '\"Fine ID: 5, was created\"', '2024-12-17 21:21:46'),
(9, 3, 'Fines', '5', 'UPDATE', '\"Fine ID: 5, was updated\"', '2024-12-17 21:22:53'),
(10, 3, 'Incident', '6', 'DELETE', '\"Incident ID: 6, was deleted\"', '2024-12-17 21:24:13'),
(11, 3, 'Incident', '7', 'INSERT', '\"Incident ID: 7, was created\"', '2024-12-17 21:25:13'),
(12, 3, 'Fines', '6', 'INSERT', '\"Fine ID: 6, was created\"', '2024-12-17 21:27:15'),
(13, 3, 'Fines', '7', 'INSERT', '\"Fine ID: 7, was created\"', '2024-12-17 21:42:18'),
(14, 3, 'Fines', '7', 'DELETE', '\"Fines ID: 7, was deleted\"', '2024-12-17 21:42:36'),
(15, 3, 'Fines', '8', 'INSERT', '\"Fine ID: 8, was created\"', '2024-12-17 21:46:05'),
(16, 3, 'Fines', '8', 'DELETE', '\"Fines ID: 8, was deleted\"', '2024-12-17 21:52:21'),
(17, 3, 'Fines', '8', 'DELETE', '\"Fines ID: 8, was deleted\"', '2024-12-17 21:52:46'),
(18, 1, 'Incident', '8', 'INSERT', '\"Incident ID: 8, was created\"', '2024-12-17 21:54:00'),
(19, 4, 'Vehicle', '14', 'INSERT', '\"Ownership successfully linked (People_ID: 493, Vehicle_ID: 19)\"', '2024-12-17 21:55:34');
...
INSERT INTO `Incident` (`Incident_ID`, `Vehicle_ID`, `People_ID`, `Incident_Date`, `Incident_Time`, `Incident_Report`, `Offence_ID`) VALUES
(1, 15, 4, '2017-12-01', '14:30', '40mph in a 30 limit', 1),
(2, 20, 8, '2017-11-01', '14:30', 'Double parked', 4),
(3, 13, 4, '2017-09-17', '14:30', '110mph on motorway', 1),
(4, 14, 2, '2017-08-22', '14:30', 'Failure to stop at a red light - travelling 25mph', 8),
(5, 13, 4, '2017-10-17', '14:30', 'Not wearing a seatbelt on the M1', 3),
(7, 69, 443, '2024-12-04', '05:32', 'Driving recklessly', 5),
(8, 54, 448, '2024-12-12', '21:53', 'Ran a red light', 7);
...
CREATE TABLE `Officers` (
  ...
  `Officer_credentials` varchar(255) NOT NULL,
...
INSERT INTO `Officers` (`Officer_ID`, `Officer_name`, `Officer_credentials`, `Username`, `Password`) VALUES
(1, 'Derek Morgan', 'Detective', 'mcnulty', 'plod123'),
(2, 'Penelope Garcia', 'Sergeant', 'moreland', 'fuzz42'),
(3, 'Jasmine Daniels', 'Administrator', 'daniels', 'copper99'),
(4, 'James Fullman', 'Officer', 'jfullman', '12345'),
(6, 'Meredith Geller', 'Administrator', 'mgeller', 'mg123'),
(7, 'Tom Hanks', 'Administrator', 'thanks', 'thanks123'),
(14, 'Lily  Smith', 'Officer', 'lsmith', 'lsmith123'),
(16, 'Lily Woods', 'Officer', 'lwoods', 'lwoods123'),
(17, 'Grace Woods', 'Officer', 'gwoods', 'gwoods123'),
(18, 'Sarah Lee', 'Administrator', 'slee', 'slee123'),
(19, 'Pluto Venus', 'Administrator', 'pvenus', 'pvenus123'),
(20, 'Laura Cross', 'Administrator', 'lcross', 'lcross123'),
(21, 'Rachel Green', 'Detective', 'rgreen', 'rgreen123');
...
(512, 'Jessica Williams', '42 Carol street, East Rachelville, CB9M 1BT', 'WILLI09IGVODK30'),
(513, 'Grace Bird', 'Studio 55f, Riley causeway, Harristown, B4 0WD', 'BIRD91JUBLEV33'),
(514, 'Jonathon Harris', '281 Joan isle, Middletontown, N5T 3LE', 'HARRI20CJLMEX66'),
(515, 'Kemi Jones', '48 Jessica river, Goughbury, SA4 4FA', 'JONES28DFSFQQ11');
...
--
ALTER TABLE `Officers`
  MODIFY `Officer_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `People`
  MODIFY `People_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=516;

--
-- AUTO_INCREMENT for table `Vehicle`
--
ALTER TABLE `Vehicle`
  MODIFY `Vehicle_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=643;
